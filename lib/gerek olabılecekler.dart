...
// // //     String query =
// // //         "Select * From note Inner Join category on category.categoryID = note.categoryID Where time Like '$suan%' order by ";
// // //     switch (sortBy) {
// // //       case 0:
// // //         query += "categoryTitle";
// // //         break;
...
// // //         "Select * From note Inner Join category on category.categoryID = note.categoryID Order By id Asc;");
// // //     List<Note> noteList = [];
// // //     for (Map map in noteMaplist) {
// // //       noteList.add(Note.fromMap(map));
// // //     }
...
// // //     Database db = await _getDatabase();
// // //     List<Map<String, dynamic>> noteMaplist = await db.rawQuery(
// // //         "Select * From note Inner Join category on category.categoryID = note.categoryID Where note.categoryID = $categoryID Order By id Desc;");
// // //     List<Note> noteList = [];
// // //     for (Map map in noteMaplist) {
// // //       noteList.add(Note.fromMap(map));
// // //     }
